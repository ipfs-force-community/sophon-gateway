...
type IProofEventStruct struct {
	...
	ComputeProof        func(ctx context.Context, miner address.Address, sectorInfos []proof5.SectorInfo, rand abi.PoStRandomness) ([]proof5.PoStProof, error) `perm:"write"`
}
...
type IWalletEvent struct {
	...
	WalletSign             func(ctx context.Context, account string, addr address.Address, toSign []byte, meta wallet.MsgMeta) (*crypto.Signature, error) `perm:"sign"`
	...
	SupportNewAccount   func(ctx context.Context, channelId uuid.UUID, account string) error                                  `perm:"write"`
	AddNewAddress       func(ctx context.Context, channelId uuid.UUID, newAddrs []address.Address) error                      `perm:"write"`
	RemoveAddress       func(ctx context.Context, channelId uuid.UUID, newAddrs []address.Address) error                      `perm:"write"`
}
